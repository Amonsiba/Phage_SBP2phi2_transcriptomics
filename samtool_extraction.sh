...
SAM="/pub/amonsiba/Projects/240820_RNAseq.ch2/results/coverage/250113_Coverage_Phage/terminase_adjusted_fasta/txt_files"

output_file="$SAM/coverage_summary_phage_terminase_adjusted.csv"
